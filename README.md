...
Разработка происходит в ветке [dev](https://github.com/JerryCarson/ecg_stm/tree/dev)
...
![Architecture Diagram](readme_imgs/scheme.svg)
...
- [ ] Протокол общения с ПК: отправка считанных данных, обработка команд (есть рабочий прототип, нужно отредактировать его под конкретный набор команд)
